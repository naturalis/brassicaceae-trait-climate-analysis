...
formula_1 <- Growth_habit ~ annualPET + PETDriestQuarter + aridityIndexThornthwaite +  thermicityIndex
```

#some random brench lengths until the cladogram is finished
```{r}
random <- runif(n = 88, min = 0, max = 2)
BrassiToL_Lepidium$edge.length <- random
```
